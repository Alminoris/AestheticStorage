...
public class HalfcabinetScreenHandler extends ScreenHandler
{
    ...
    //Client
    public HalfcabinetScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf)
    {
        this(syncId, inventory, (HalfcabinetBlockEntity) inventory.player.getWorld().getBlockEntity(buf.readBlockPos()));
    }
