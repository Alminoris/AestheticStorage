...
public class ModBlockEntities
{
    ...
    public static final BlockEntityType<HalfcabinetBlockEntity> HALFCABINET_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(AestheticStorage.MOD_ID, "halfcabinet_be"),
    ...
    public static final BlockEntityType<HalfcupboardBlockEntity> HALFCUPBOARD_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(AestheticStorage.MOD_ID, "halfcupboard_be"),
