...
{
    public HalfcabinetBlockEntityRenderer(BlockEntityRendererFactory.Context context)
    {

    }

    @Override
    public void render(HalfcabinetBlockEntity entity, float tickDelta, MatrixStack matrices,
