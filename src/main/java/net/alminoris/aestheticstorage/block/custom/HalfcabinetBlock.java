...
public class HalfcabinetBlock extends BlockWithEntity implements BlockEntityProvider
{
    ...
    public static final MapCodec<HalfcabinetBlock> CODEC_WITH_FLIP =
            createCodec(settings -> new HalfcabinetBlock(settings, true));

    public static final MapCodec<HalfcabinetBlock> CODEC_WITHOUT_FLIP =
            createCodec(settings -> new HalfcabinetBlock(settings, false));
    ...
    {
        return validateTicker(type, ModBlockEntities.HALFCABINET_BLOCK_ENTITY,
