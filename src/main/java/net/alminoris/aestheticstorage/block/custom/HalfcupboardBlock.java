...
public class HalfcupboardBlock extends BlockWithEntity implements BlockEntityProvider
{
    ...
    {
        return type == ModBlockEntities.HALFCUPBOARD_BLOCK_ENTITY ? (world1, pos, state1, blockEntity) ->
        {
            if (blockEntity instanceof HalfcupboardBlockEntity cupboardBlockEntity)
            {
