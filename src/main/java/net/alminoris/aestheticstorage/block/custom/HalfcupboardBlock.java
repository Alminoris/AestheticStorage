...
public class HalfcupboardBlock extends BlockWithEntity implements BlockEntityProvider
{
    ...
    private static final VoxelShape SHAPE = Block.createCuboidShape(0D, 0D, 9D, 16D, 16D, 16D);
    ...
    public static final EnumProperty<HalfcupboardBlock.Variant> VARIANT = EnumProperty.of("variant", HalfcupboardBlock.Variant.class);

    public static final MapCodec<HalfcupboardBlock> CODEC = HalfcupboardBlock.createCodec(HalfcupboardBlock::new);
    ...
    protected void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved)
    {
        if (state.getBlock() != newState.getBlock())
        {
            ...
            {
                ItemScatterer.spawn(world, pos, (HalfcupboardBlockEntity)blockEntity);
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit)
    {
        ...
        NamedScreenHandlerFactory screenHandlerFactory = ((HalfcupboardBlockEntity) world.getBlockEntity(pos));
        ...
        while (!stack.isEmpty())
        {
                    ...
                    currentState.get(FACING) == facing)
            {
                ...
                Variant currentVariant = currentState.get(HalfcupboardBlock.VARIANT);
    ...
    {
        return validateTicker(type, ModBlockEntities.HALFCUPBOARD_BLOCK_ENTITY,
