...
public class ModBlocks
{
    ...
    public static Block registerBlock(String name, Block block)
    {
        ...
        return Registry.register(Registry.BLOCK, new Identifier(AestheticStorage.MOD_ID, name), block);
    }

    private static void registerBlockItem(String name, Block block)
    {
        Registry.register(Registry.ITEM, new Identifier(AestheticStorage.MOD_ID, name),
